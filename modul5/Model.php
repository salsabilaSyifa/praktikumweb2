<?php
    ...
    class Model
    {
        ...
        public function setMember($nama, $nomor, $alamat, $tgl_mendaftar, $tgl_terakhir_bayar)
        {
        ...
        public function editMember($id, $nama, $nomor, $alamat, $tgl_mendaftar, $tgl_terakhir_bayar)
        {
